...
(function (factory) {
  ...
  Wookmark.prototype.getItemWidth = function () {
    var itemWidth = this.itemWidth,
      innerWidth = (getWidth(this.container) - 20) - 2 * this.outerOffset,
    ...
    if (flexibleWidth) {
      ...
      var paddedInnerWidth = (innerWidth + this.offset),
        ...
        columnWidth = Math.max(flexibleWidth, Math.floor((innerWidth - (columns - 1) * this.offset) / columns));

      itemWidth = Math.min(itemWidth, columnWidth);
    }
  ...
  Wookmark.prototype.layout = function (force, callback) {
    ...
    var calculatedItemWidth = this.getItemWidth(),
      ...
      containerWidth = getWidth(this.container) - 20,
    ...
    if (this.itemHeightsDirty || !this.itemHeightsInitialized) {
      while (i--) {
        ...
        if (this.flexibleWidth) {
          ...
          item.style.height = (calculatedItemWidth * 2 / 3) + 'px';
        }
