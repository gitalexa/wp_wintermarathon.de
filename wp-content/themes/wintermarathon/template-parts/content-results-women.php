...
if($selector) {
    ...
    if (DbBridge()->table_exists($table_name)) {
        $retrieve_data = DbBridge()->get_results_women($table_name, $selector);

        if(sizeof($retrieve_data) > 0):
        ?>

        <div class="result-table">
            <h3>Frauen <?php the_title() ?></h3>
            <table class="preview-result">
                ...
                for($i = 0; $i < sizeof($retrieve_data) && $i < 5; $i++) {
                    ...
                    foreach($starterArray as $starter) {
                        ...
                        $starterEntry .= $retrieve_data[$i]->position_women . "','Frauen','";
                    ...
                    <tr>
                        <td><p><?php echo $retrieve_data[$i]->position_women; ?></p></td>
                    ...
                    <table class="full-result">
                        ...
                        foreach ($retrieve_data as $retrieved_data) {
                            ...
                            foreach($starterArray as $starter) {
                                ...
                                $starterEntry .= $retrieved_data->position_women . "','Frauen','";
                                $starterEntry .= date('d.m.Y',strtotime(CFS()->get('datum_des_marathons'))) . "','".$selector."')";
                                $starterEntry .= '">' . trim($starter) . "</a>";
                            }
                            ?>
                            ...
                            <tr>
                                <td><p><?php echo $retrieved_data->position_women; ?></p></td>
